...
agent = Agent(
    MetaAIChatModel(),
    system_prompt=(
        "You are a helpful assistant, provide the answers to the users query"
        "You can take help of the tools provided to you for providing the most relevant answer"
    ),
)
